        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <Link to="/" className="flex items-center gap-2 transition-opacity hover:opacity-90">
              <GraduationCap className="theme-accent h-8 w-8" />
              <span className="hidden text-lg font-bold sm:block">UR Past Papers</span>
            </Link>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div>
              <div className="mb-3 flex items-center gap-2">
                <GraduationCap className="theme-accent h-6 w-6" />
                <span className="theme-title font-bold">UR Past Papers</span>
              </div>
            ...
            <div>
              <h3 className="theme-title mb-3 font-semibold">About</h3>
              <p className="theme-muted text-sm">
                Built for UR students, by UR students. Helping each other succeed academically.
              </p>
            </div>
          </div>
          <div className="theme-muted mt-8 border-t border-border/70 pt-6 text-center text-sm">
            Copyright 2026 UR Academic Resource Hub. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
