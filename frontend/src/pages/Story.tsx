            ...
            <div className="rounded-2xl border border-border/70 bg-background p-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">A lead builder and creative technologist at the forefront of the project, driving its vision, shaping its experience, and turning ideas into impactful digital solutions.</p>
                </div>
              </div>
              <a
            ...
            <div className="rounded-2xl border border-border/70 bg-background p-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">A strategic collaborator contributing to the platform’s vision, shaping its story and user experience, and leading the generation of core project ideas.</p>
                </div>
              </div>
              <a
