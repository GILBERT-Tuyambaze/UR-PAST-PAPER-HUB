            ...
            <div className="rounded-2xl border border-border/70 bg-background p-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Co-operator and teammate helping shape the platform story and experience and is the project ideal generator</p>
                </div>
              </div>
              <a
